...
load("UX-10thMay-PM-2017.RData") # last known build
...
# refer to the games name and and main objective.
neutral_words <- (c("zombie","zombies","dying","game"))
...
best_cooccurences <- filter(word_cooccurences, n > 50)
best_cooccurences
...
# Now plot sentiment for our 4 catergories of posts
...
PandP_sentences <- data_frame(text= iconv(original_posts,to='latin1')) %>% 
  unnest_tokens(sentence, text, token = "sentences")
